...
//           <img src="/images/user/profile4.jfif" alt="User" />
//         </span>
...
//           className="flex items-center gap-3 px-3 py-2 mt-3 font-medium text-gray-700 rounded-lg group text-theme-sm hover:bg-blue-300 hover:text-white dark:text-gray-400 dark:hover:bg-white/5 dark:hover:text-gray-300"
//         >
//           <svg
